...
export const PORTFOLIO_PROJECTS: PetProgectsData[] = [
  ...
  },
  {
    ...
    skills:
      'NestJS, TypeScript, PostgreSQL, TypeORM, Swagger, Socket.io, firebase-admin',
    role: 'Full-Stack Developer (Backend Focus)',
    imageProject: '/img/farm.jpeg',
    isMaintenance: true,
    description:
