...
const StorybookIcon: React.FC<IconProps> = ({
  id = 'storybook',
  width = '32px',
  height = '32px',
  className,
  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <mask id="mask-storybook" fill="white">
          <use xlinkHref="#path-storybook" />
        </mask>

        <use
          fill="url(#storybookGradient)"
          fillRule="nonzero"
          xlinkHref="#path-storybook"
        />
