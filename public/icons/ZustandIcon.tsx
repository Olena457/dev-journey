...
const ZustandIcon: React.FC<IconProps> = ({
  id = 'zustand',
  width = '32px',
  height = '32px',
  className,
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="zustandGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <g id="SVGRepo_iconCarrier" fill="url(#zustandGradient)">
        <title>{'Zustand icon'}</title>
        <g>
          <g id="Layer_1_134_">
            <g>
