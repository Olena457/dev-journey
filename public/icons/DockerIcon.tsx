    ...
    >
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          ...
          fill="#2396ED"
        />
        <path d="M2.89 5.784h1.413v1.315H2.89z" fill="#2396ED" />
        <path d="M4.837 5.784h1.413v1.315H4.837z" fill="#820f84 " />
        <path d="M6.789 5.784h1.412v1.315H6.789z" fill="#2396ED" />
        <path d="M8.741 5.784h1.411v1.315H8.741z" fill="#820f84 " />
        <path d="M4.835 3.892h1.412v1.315H4.835z" fill="#2396ED" />
        <path d="M6.811 3.892h1.412v1.315H6.811z" fill="#820f84 " />
        <path d="M6.811 2h1.412v1.316H6.811z" fill="#2396ED" />
      </g>
    </svg>
  );
};
